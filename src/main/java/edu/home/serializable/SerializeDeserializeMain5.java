...
class Person5 {
    ...
    public Person5(final String name, final String nationality) {
        super();
        this.name = name;
...
class Employee5 extends Person5 implements Serializable {
    ...
    public Employee5(final int employeeId, final String name, final String department, final String nationality) {
