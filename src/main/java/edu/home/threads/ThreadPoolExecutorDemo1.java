...
public class ThreadPoolExecutorDemo1 {
    public static void main(final String[] args) {
        ...
        final ThreadPoolExecutor threadPool = new ThreadPoolExecutor(2, 4, 30, TimeUnit.SECONDS, queue); // Put
        // break
        // point
        try {
            ...
            threadPool.execute(r); // throws RejectedExecutionHandler i.e., task
                                   // is rejected
            threadPool.execute(r); // throws RejectedExecutionHandler i.e., task
                                   // is rejected
            threadPool.execute(r); // throws RejectedExecutionHandler i.e., task
